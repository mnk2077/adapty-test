...
export const UiKitConfig: SchemaType = {
  version: 1.0,
  strict: {
    'border-radius': 5,
    ...
    'text-subtitle-1-font-family': 'Roboto-SemiBold',
    // Same for `s2`
    ...
    'text-hint-color': '#424242',
    'text-basic-color': '#424242',
  },
  components: {
    Avatar: {
      meta: {
      ...
      appearances: {
        default: {
          ...
          variantGroups: {
            status: {
              basic: {
                indicatorColor: 'color-basic-default',
                trackColor: 'color-basic-transparent-default',
              },
              primary: {
                indicatorColor: 'color-primary-default',
                trackColor: 'color-primary-transparent-active',
              },
              success: {
                indicatorColor: 'color-success-default',
                trackColor: 'color-success-transparent-active',
              },
              info: {
                indicatorColor: 'color-info-default',
                trackColor: 'color-info-transparent-active',
              },
              warning: {
                indicatorColor: 'color-warning-default',
                trackColor: 'color-warning-transparent-active',
              },
              danger: {
                indicatorColor: 'color-danger-default',
                trackColor: 'color-danger-transparent-active',
              },
              control: {
                indicatorColor: 'color-control-default',
                trackColor: 'color-control-transparent-active',
              },
            },
            size: {
              tiny: {
          ...
          variantGroups: {
            status: {
              basic: {
                ...
                iconTintColor: 'placeholder-color',
                state: {
                  focused: {
                    borderColor: 'color-primary-default',
                    backgroundColor: 'background-basic-color',
